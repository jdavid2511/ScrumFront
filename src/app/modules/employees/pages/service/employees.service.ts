...
export class EmployeesService {
  private API_SERVER = 'https://scrumbackend.azurewebsites.net/employee';
  ...
  getAreaByEmployee(employeeId: string | null): Observable<any>{
    ...
    // const token: string | null= ''+localStorage.getItem('token')
    const headers = new HttpHeaders().set("Authorization", token);
    return this.httpClient.get('https://scrumbackend.azurewebsites.net/area/employee/'+ employeeId,{headers})
  }
}
